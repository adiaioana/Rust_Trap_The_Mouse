...
impl Board{
    pub fn plays(&mut self) {
        self.token=true;
    }
    pub fn isgamestarted(&mut self) ->bool{
        self.token
    }
    pub fn new() -> Self{
        ...
        Board{dimcol:11, dimlin:11, matrix:mat, mouse_pos:(6,6),token:false}
    }

    pub fn get_prop(&self, pos:(i32,i32)) -> Cellprop {
        self.matrix[pos.0 as usize][pos.1 as usize].prop
    }
